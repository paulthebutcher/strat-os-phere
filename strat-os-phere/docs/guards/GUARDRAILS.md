...
**Purpose**: Layered guardrail system for stable, trustworthy outputs (evidence quality, scoring, drift detection).
...
**Related docs**:
- [../pipeline/ANALYSIS_PIPELINE.md](../pipeline/ANALYSIS_PIPELINE.md) - How analysis is generated
- [../data/DATA_MODEL.md](../data/DATA_MODEL.md) - Signal storage in artifacts

...
**Purpose**: Web search and scraping for evidence generation, evidence cache, and source storage.

**When to read this**: Read this to understand how evidence is automatically generated from web search and scraping.

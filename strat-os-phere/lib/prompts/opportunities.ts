...
export function buildOpportunitiesMessages(
  ...
  const userContent = [
    ...
    '- Reference live signals when available: "Based on recent G2 reviews, users report...", "Pricing page shows...", "Changelog indicates recent addition of..."',
    ...
    '- When snapshots include customer_struggles, use these to identify pain points that create opportunities',
    '',
    ...
    '',
    'OPPORTUNITY SIGNALS - Look for these patterns:',
    '- Pricing friction: If reviews or pricing pages show pricing complaints, consider pricing_packaging opportunities',
    '- User complaints: If customer_struggles in snapshots show repeated complaints, these indicate product_capability or workflow opportunities',
    '- Recent feature gaps: If changelog shows recent additions, consider what they\'re NOT doing yet (opportunity)',
    '- Jobs page signals: If they\'re hiring for specific roles, consider what capabilities they\'re building (and what gaps exist)',
    '',
    'QUALITY STANDARDS',
    ...
    '- Flag opportunities driven by pricing friction, user complaints, or recent feature gaps in the "why_now" field',

...
-- Purpose: Cache fetched and extracted web content for performance optimization
-- This table is not directly related to projects (shared cache across projects)
